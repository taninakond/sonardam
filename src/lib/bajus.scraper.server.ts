...
export const FALLBACK_DATA: Omit<LivePrices, "fetchedAt" | "source" | "note"> = {
...
export async function scrapeBajusPrices(): Promise<LivePrices> {
  ...
  const silverG = ag ?? FALLBACK_DATA.silver_gram;
